            ...
            <div class="jarviswidget jarviswidget-color-blueDark"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <div role="content">
                    ...
                    <div class="widget-body no-padding">
                       ...
                       <form class="smart-form" method="post" action="{{url('admin/post_edit_color')}}" enctype="multipart/form-data">
                                ...
                                <div class="col col-6">
                                    ...
                                    <section>
                                        ...
                                        <label class="input" for="">
                                            <input type="text" class="form-control" name="title" value="{{$id->name}}" required>
                                        </label>
                                        ...
                                        <label class="input" for="">
                                            <input type="text" class="form-control" name="title_en" value="{{$id->name_en}}" required>
                                        </label>

                                        <p><br></p>
                                        <label class="label" for="">Color</label>

                                        <input type="color" name="color" value="{{$id->code}}">
