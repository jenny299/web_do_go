        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <header>
                    ...
                    <h2><a href="#dm_cha" class=" back-link-icon" title=""><i class="fa fa-arrow-circle-o-left"></i></a> Edit Danh Mục Sản Phẩm</h2>
                ...
                <div role="content">
                    ...
                    <div class="widget-body no-padding">
                       ...
                       <form class="smart-form" method="post" action="{{url('admin/post_edit_dm_cha')}}" enctype="multipart/form-data">
