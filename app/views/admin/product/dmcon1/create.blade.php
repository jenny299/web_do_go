<section class="content-header">
    ...
    <h1>
        ...
        Insert Danh Mục Sản Phẩm (cấp 1)
        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark"  data-widget-colorbutton="false" data-widget-editbutton="false" role="widget" style="">
                ...
                <header>
                    ...
                    <h2><a href="#dm_con1/{{$id}}" class=" back-link-icon" title=""><i class="fa fa-arrow-circle-o-left"></i></a> Thêm Danh Mục Sản Phẩm (cấp 1)</h2>
                ...
                <div role="content">
                    ...
                    <div class="widget-body no-padding">
                      ...
                      <form class="smart-form" method="post" action="{{url('admin/post_create_dm_con1')}}" enctype="multipart/form-data">
