        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <header>
                    ...
                    <h2><a href="#dm_con1/{{$id->id_dmcha}}" class=" back-link-icon" title=""><i class="fa fa-arrow-circle-o-left"></i></a> Edit Danh Mục Sản Phẩm (cấp 1)</h2>
                ...
                <div role="content">
                    ...
                    <div class="widget-body no-padding">
                       ...
                       <form class="smart-form" method="post" action="{{url('admin/post_edit_dm_con1')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col col-10">
                                    ...
                                    <section>
                                        ...
                                        <input type="hidden" name="id_cha" value="{{$id->id_dmcha}}">
