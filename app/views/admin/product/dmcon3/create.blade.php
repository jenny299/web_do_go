<section class="content-header">
    ...
    <h1>
        ...
        Insert Danh Mục Sản Phẩm (cấp 3)
        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark"  data-widget-colorbutton="false" data-widget-editbutton="false" role="widget" style="">
                ...
                <header>
                    ...
                    <h2><a href="#dm_con3/{{$id}}" class=" back-link-icon" title=""><i class="fa fa-arrow-circle-o-left"></i></a> Insert Danh Mục Sản Phẩm (cấp 3)</h2>
                ...
                <div role="content">
                    ...
                    <div class="widget-body no-padding">
                      ...
                      <form class="smart-form" method="post" action="{{url('admin/post_create_dm_con3')}}" enctype="multipart/form-data">
