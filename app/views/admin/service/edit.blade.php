        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <header>
                    ...
                    <h2><a href="#service" class=" back-link-icon" title=""><i class="fa fa-arrow-circle-o-left"></i></a> Edit Content</h2>
                ...
                <div role="content">
                    ...
                    <div class="widget-body no-padding">
                       ...
                       <form class="smart-form" method="post" action="{{url('admin/post_edit_service')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col col-10">
                                    ...
                                    <section>
                                        ...
                                        <label class="label"><b>Sercive (Việt Nam)</b></label>
                                        <label class="input" for="">
                                           <textarea class="form-control editor" id="editor1" name="content">{{$id->content}}</textarea>
                                        </label>

                                        <p><br></p>
                                        <label class="label"><b>Sercive (English)</b></label>
                                        <label class="input" for="">
