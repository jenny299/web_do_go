...
//$baseUrl = '/Dropbox/WebsiteProject/stmary/public/upload/image/'; //Localhost

$baseUrl = '/timax1/upload/image/'; //Server qdesign
// $baseUrl = '/public/upload/image/'; //Server qdesign
